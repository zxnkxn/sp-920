...
/* Modified from hpm6750evk2 board.h for SP-920 */
...
#define BOARD_NAME          "sp-920" // Modified for SP-920
...
#define BOARD_SDRAM_SIZE             (64 * SIZE_1MB) // Modified for SP-920
...
// Modified for SP-920: I2C0 EEPROM lines are connected to PA05 (SDA) and PA06 (SCL)
#define BOARD_CAP_I2C_SDA_GPIO_INDEX (GPIO_DI_GPIOA)
#define BOARD_CAP_I2C_SDA_GPIO_PIN   (5)
#define BOARD_CAP_I2C_CLK_GPIO_INDEX (GPIO_DI_GPIOA)
#define BOARD_CAP_I2C_CLK_GPIO_PIN   (6)
...
#define BOARD_SHOW_CLOCK 0 // Modified for SP-920
#endif
